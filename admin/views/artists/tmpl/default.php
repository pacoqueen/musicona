...
<?php
	...
	JToolBarHelper::title(   JText::_( 'Artist Manager' ), 'generic.png' );
	...
	JToolBarHelper::help( 'screen.artist' );
?>
...
?>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++) {
          ...
          $link 	= JRoute::_( 'index.php?option=com_musicona&c=artists&task=edit&cid[]='. $row->id );
          ...
          ?>
            <tr class="<?php echo "row$k"; ?>">
               ...
               <td>
                 <?php
                   if (JTable::isCheckedOut($this->user->get ('id'), $row->checked_out )) {
                     ...
                     ?>
                     <a href="<?php echo $link; ?>" title="<?php echo JText::_( 'Edit Artist' ); ?>">
                       <?php echo $row->name; ?>
                       </a>
                           <?php } ?>
               </td>
               ...
               <td class="order">
                   <span>
                       <?php echo $this->pagination->orderUpIcon( $i, 1, 'orderup', 'Move Up', $ordering ); ?>
                   </span>
                   <span>
                       <?php echo $this->pagination->orderDownIcon( $i, $n, 1, 'orderdown', 'Move Down', $ordering ); ?>
                   </span>
