 ...
 * @since 1.5
 */
class MusicControllerArtists extends JController
{
	...
	function display()
  	{
	  JRequest::setVar( 'model'  , 'artists');
	  JRequest::setVar( 'view'  , 'artists');
	  parent::display();
	}
	...
	function save()
	{
		...
		if ($model->store($post)) {
			$msg = JText::_( 'Artist Saved' );
		} else {
			$msg = JText::_( 'Error Saving Artist' );
		}
