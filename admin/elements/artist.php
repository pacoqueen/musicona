...
class JElementArtist extends JElement
{
  var   $_name = 'artist';
  ...
  function fetchElement($name, $value, &$node, $control_name)
  {
    $db = &JFactory::getDBO();
      ...
      $query = "SELECT id AS value, name AS text FROM #__artists"
	.' ORDER BY ordering';
...
// 	.' ORDER BY czlo_nazwisko, czlo_imie';
      ...
      array_unshift($options, JHTML::_('select.option', '0', '- '.JText::_('Select Artist').' -', 'value', 'text'));
